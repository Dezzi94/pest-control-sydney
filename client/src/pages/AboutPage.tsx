  ...
  return (
    <Layout>
      ...
      <section className="noise-overlay relative bg-slate-900 text-white py-20 lg:py-28 overflow-hidden">
        <img src="/images/hero/team-professional.jpg" alt="" className="absolute inset-0 w-full h-full object-cover object-center" loading="eager" />
        ...
        >
          <div className="max-w-4xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              <div className="lg:col-span-3 prose prose-slate max-w-none space-y-4">
              ...
              <div className="lg:col-span-2 space-y-4">
                <img
                  src="/images/sections/service-van.jpg"
                  alt="Pest Control Sydney service vehicle ready for dispatch"
                  width={800}
                  height={600}
                  className="rounded-xl object-cover w-full h-48 lg:h-auto"
                  loading="lazy"
                />
                <img
                  src="/images/sections/technician-equipment.jpg"
                  alt="Licensed pest control technician with professional equipment"
                  width={800}
                  height={600}
                  className="rounded-xl object-cover w-full h-48 lg:h-auto"
                  loading="lazy"
